-- 189-match-chunks-topic-scope.sql
-- ADR-017 vN (#11) — content.match_chunks honors scope_type='topic'.
-- A document matches a topic-scope grant when content.document_topics joins
-- doc.id to a row whose topic_id::text = grant.scope_ref.
